...
$count=mysql_query("SELECT * FROM table_product WHERE visible='0' AND title LIKE '%$search%'");
$temp=mysql_fetch_array($count);

$result1=mysql_query("SELECT * FROM table_product WHERE visible='0'AND title LIKE '%$search%'");
echo mysql_error();
